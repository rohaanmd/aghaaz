export const data = [
	...
	},
	{
		...
		rules: [
			...
			"Participants will be judged on the basis of costume, theme, walk, stance, attitude and also their talent.",
			"Corporate theme of the even need to be strictly followed.",
			"Participants may use props like suitcase, files, hats or anything complementing their look with respect to the theme.",
			"Green room facilities are available.",
			"Any kind of misbehavior or vulgarity is strictly prohibited. These activities may lead to disqualification from the event.",
		],
	},
	{
...

	{
		...
		rules: [
			...
			"Participants will have to speak in FAVOUR of the topic for 2 minutes and AGAINST the topic for the next 2 minutes",
			"Only shortlisted participants will go for 2 rounds.",
		],
	},
	{
	...
	"Any kind of misconduct will not be tolerated."
	],
	},
];
